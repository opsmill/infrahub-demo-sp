...
@pytest.mark.parametrize(
    "variable", ["INFRAHUB_TESTING_IMAGE_VER", "INFRAHUB_TESTING_IMAGE_VERSION"]
)
...
def test_reference_joins_repository_and_tag() -> None:
    ...
    assert (
        StackImage("opsmill/custom", "1.12.0", pull=False, custom_build=True).reference
        == "opsmill/custom:1.12.0"
    )
